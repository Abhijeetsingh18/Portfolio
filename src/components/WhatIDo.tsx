        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Description</h4>
              <p>
                Architecting modular backend applications, implementing JDBC-based
                CRUD operations, and engineering database persistence with MySQL,
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Description</h4>
              <p>
                Developing intuitive graphical desktop interfaces and responsive
                web frontends using Java Swing, AWT, HTML5, CSS3, JavaScript, and
                Bootstrap.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
                <div className="what-tags">Java Swing</div>
                <div className="what-tags">AWT</div>
                ...
                <div className="what-tags">NetBeans</div>
              </div>
              <div className="what-arrow"></div>
            </div>
          </div>
